...
<body>
    ...
    <div class="formulario">
        ...
        <form method="post">
            ...
            <fieldset>
                ...
                <label for = "Feredativa"> Entidad federativa de procedencia: </label><br>
        ...
        <button onclick="validar()"  class="btn btn-primary">Enviar</button>
        <button onclick="location.reload()" class="btn btn-danger">Limpiar</button>        
        <br><br>
        <a  href="php/recuperar.php">Recuperar PDF</a><br>
        <a  href="php/crudLogin.php">Modo CRUD</a>
    ...
    <div class="verInfo off">
        <div class="des">  
        </div>
        <br><br>
        <button onclick="aceptarCambios()" class="btn btn-primary">Aceptar</button>
        <button onclick="editarContenido()" class="btn btn-danger">Modificar</button>
    </div>
